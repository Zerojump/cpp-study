...
#define DBHOST "tcp://172.17.0.1:3306"
#define USER "root"
...
int main(int argc, const char *argv[]) {
    ...
    // const sql::SQLString& url(argc >= 2 ? argv[1] : DBHOST);
    // const sql::SQLString& user(argc >= 3 ? argv[2] : USER);
    // const sql::SQLString& password(argc >= 4 ? argv[3] : PASSWORD);
    // const sql::SQLString& database(argc >= 5 ? argv[4] : DATABASE);

    const sql::SQLString& url = "tcp://172.17.0.1:3306";
    const sql::SQLString& user = "root";
    const sql::SQLString& password = "123456";
    const sql::SQLString& database = "test";
    ...
    try {
        ...
        /* alternafate syntax using auto_ptr to create the db connection */
        ...
        retrieve_data_and_print (res, NUMOFFSET, 1, string("cname"));
        ...
        prep_stmt = con -> prepareStatement ("INSERT INTO city (cname) VALUES (?)");
        ...
        /* retrieve the data from the result set and display on stdout */
        retrieve_data_and_print (res, COLNAME, 1, string ("cname"));
